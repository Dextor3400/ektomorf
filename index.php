...
<body>
    <div class="wrapper-fluid wrapper-navbar">
        ...
        <div class="jumbotron shows-jumbotron" style="height: 90vh; background-color: rgba(6, 6, 6, 0.74);">
            <div class="container">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="d-flex justify-content-end">
                            <a class="btn mt-2 border px-4" href="">Tickets</a>
                        </td>
                    </tr>
                    <tr>
                        <th class="align-middle" scope="row">
                ...
                <div class="d-flex justify-content-center align-items-center mt-5">
                    <a href="" class="btn border px-4 py-3 mr-3">
                        VIP UPGRADES
                    </a>
                    <a href="" class="btn border px-4 py-3">
                        2019 TOUR VIDEOS
                    </a>
                </div>
            </div>
